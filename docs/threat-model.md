...
| 19 | Mutable model pointer (e.g. "latest") | **Prevented by policy + design.** The wrapper only accepts immutable, content-addressed 0G Storage root hashes — never a mutable alias. Enforced in the wrapper reference implementation (Phase 7). |
